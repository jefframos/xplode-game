...
!function() {
    ...
    var a = this, b = b || {};
    b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.3", b.blendModes = {
        NORMAL: 0,
        ADD: 1,
        MULTIPLY: 2,
        SCREEN: 3,
    ...
    b.BitmapText.prototype.setText = function(a) {
        ...
        var d = a.worldTransform, e = this.global, f = d.a, g = d.c, h = d.tx, i = d.b, j = d.d, k = d.ty, l = 1 / (f * j + g * -i);
        return c = c || new b.Point(), c.x = j * l * e.x + -g * l * e.y + (k * g - h * j) * l, 
        c.y = f * l * e.y + -i * l * e.x + (-k * f + h * i) * l, c;
        ...
        this.mouseOut = !1, this.resolution = 1, this._tempPoint = new b.Point();
        ...
        for (e = 0; e < d.length; e++) {
            var f = d[e];
            b = this.touches[f.identifier], b.originalEvent = a, b.global.x = (f.clientX - c.left) * (this.target.width / c.width) / this.resolution, 
        ...
        for (var d = a.changedTouches, e = 0; e < d.length; e++) {
            ...
            g || (g = new b.InteractionData()), g.originalEvent = a, this.touches[f.identifier] = g, 
        ...
        for (var b = this.interactionDOMElement.getBoundingClientRect(), c = a.changedTouches, d = 0; d < c.length; d++) {
            ...
            for (var h = this.interactiveItems.length, i = 0; h > i; i++) {
                ...
                f.originalEvent = a, (j.touchend || j.tap) && (j.__hit && !g ? (j.touchend && j.touchend(f), 
    ...
    b.WebGLMaskManager.prototype.setContext = function(a) {
        ...
        this.texturePool.push(e), c._glFilterTexture = null;
    ...
    Object.defineProperty(b.TilingSprite.prototype, "width", {
        ...
        if (this.visible !== !1 && 0 !== this.alpha) {
            ...
            this._mask && a.maskManager.popMask(a.context), d = 0, e = this.children.length; e > d; d++) this.children[d]._renderCanvas(a);
        }
        ...
        if (this.texture.baseTexture.hasLoaded) {
            ...
            if (a ? (c = b.getNextPowerOfTwo(f.width), d = b.getNextPowerOfTwo(f.height), (f.width !== c || f.height !== d || e.baseTexture.width !== c || e.baseTexture.height || d) && (h = !0)) : g && (c = f.width, 
            d = f.height, h = !0), h) {
                var i;
    ...
    c.BoneData = function(a, b) {
        ...
        setSlotsToSetupPose: function() {
            for (var a = this.slots, b = this.drawOrder, c = 0, d = a.length; d > c; c++) b[c] = a[c], 
        ...
        readAnimation: function(a, b, d) {
            ...
            if (eb) {
                for (var m = new c.EventTimeline(eb.length), n = 0, o = 0, p = eb.length; p > o; o++) {
                    ...
                    hb.intValue = fb.hasOwnProperty("int") ? fb["int"] : gb.intValue, hb.floatValue = fb.hasOwnProperty("float") ? fb["float"] : gb.floatValue, 
                    hb.stringValue = fb.hasOwnProperty("string") ? fb.string : gb.stringValue, m.setFrame(n++, fb.time, hb);
                }
                e.push(m), f = Math.max(f, m.frames[m.getFrameCount() - 1]);
            }
            ...
            if (h) {
                ...
                if (j === c.AttachmentType.region) {
                    if (h.rendererObject && (!g.currentSpriteName || g.currentSpriteName !== h.name)) {
                        ...
                        void 0 !== g.sprites[k]) g.sprites[k].visible = !0; else {
                    ...
                    var m = g.bone;
                    i.position.x = m.worldX + h.x * m.m00 + h.y * m.m01, i.position.y = m.worldY + h.x * m.m10 + h.y * m.m11, 
                    i.scale.x = m.worldScaleX, i.scale.y = m.worldScaleY, i.rotation = -(g.bone.worldRotation * c.degRad), 
                    ...
                    if (!g.currentMeshName || g.currentMeshName !== h.name) {
                        var n = h.name;
                        if (void 0 !== g.currentMesh && (g.currentMesh.visible = !1), g.meshes = g.meshes || {}, 
                        void 0 !== g.meshes[n]) g.meshes[n].visible = !0; else {
    ...
    b.Texture.prototype.onBaseTextureLoaded = function() {
        ...
        this.baseTexture.hasLoaded = !0, b.Texture.call(this, this.baseTexture, new b.Rectangle(0, 0, this.width, this.height)), 
        this.renderer = d || b.defaultRenderer, this.renderer.type === b.WEBGL_RENDERER) {
            var g = this.renderer.gl;
            this.baseTexture._dirty[g.id] = !1, this.textureBuffer = new b.FilterTexture(g, this.width * this.resolution, this.height * this.resolution, this.baseTexture.scaleMode), 
    ...
    b.RenderTexture.prototype.resize = function(a, c, d) {
        (a !== this.width || c !== this.height) && (this.valid = a > 0 && c > 0, this.width = this.frame.width = this.crop.width = a, 
    ...
    b.JsonLoader.prototype.load = function() {
        ...
        if (this.json = JSON.parse(this.ajaxRequest.responseText), this.json.frames && this.json.meta && this.json.meta.image) {
            var a = this.baseUrl + this.json.meta.image, d = new b.ImageLoader(a, this.crossorigin), e = this.json.frames;
...
var DefaultButton = Class.extend({
    init: function(imgUp, imgOver, imgDown) {
        ...
        this.shapeButton = new PIXI.Sprite(this.textureButton), this.isOver = !1, this.isdown = !1, 
        this.width = 10, this.height = 10, this.clickCallback = null, this.mouseDownCallback = null, 
        this.mouseUpCallback = null, this.container.addChild(this.shapeButton);
    },
    destroy: function() {
